...
export default {
    ...
    methods: {
        ...
        renameClose(index) {
            ...
            // 重命名
            this.loading = true
            this.conn.send('remoteRename', {
                pathOld: path.posix.join(this.pwd, this.renameItem.name),
                pathNew: path.posix.join(this.pwd, this.renameItem.newName),
            })
                .then(() => {
